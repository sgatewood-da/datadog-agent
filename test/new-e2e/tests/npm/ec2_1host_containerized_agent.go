...
type ec2VMContainerizedAgentSuite struct {
...
func TestEC2VMSuite(t *testing.T) {
	s := &ec2VMContainerizedAgentSuite{}
...
func (v *ec2VMContainerizedAgentSuite) TestFakeIntakeNPM() {
	t := v.T()
...
func (v *ec2VMContainerizedAgentSuite) TestFakeIntakeNPM_TCP_UDP_DNS() {
	t := v.T()
